...
export class SettingsRepository {
  protected endpoint =
    "http://ec2-18-224-109-208.us-east-2.compute.amazonaws.com:8080/api/";
  protected getInfoEndpoint =
  ...
  updatePassword(userName: String, pWord: String, old_pWord: String) {
    return this.httpClient
      .put<any>(`${this.endpoint}edit-pass`, {
        userName: userName,
        pWord: pWord,
        old_pWord: old_pWord
      })
  ...
  updateIncome(userName: String, income: number) {
    return this.httpClient.put<any>(`${this.endpoint}edit-inc`, {
      userName: userName,
      income: income
    });
  }
  ...
  updateBalance(userName: String, balance: number) {
    return this.httpClient.put<any>(`${this.endpoint}edit_bal`, {
      userName: userName,
      bal: balance
    });
  }
